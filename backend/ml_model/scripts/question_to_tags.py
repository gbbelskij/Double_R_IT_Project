def assign_user_tags(user_answers):
    ...
    if '4' in user_answers:
        ...
        if project_answer == 0:   
            ...
            if '4.2' in user_answers:
                web_answer = user_answers['4.2']
                if web_answer == 0:  
    ...
    if '5' in user_answers:
        ...
        if work_answer == 0:  
            ...
            if '5.2' in user_answers:
                logic_answer = user_answers['5.2']
                if logic_answer == 0:  
                    tags["Department"].append("Data Science")
                elif logic_answer == 1: 
            ...
            if '5.3' in user_answers:
                org_answer = user_answers['5.3']
                if org_answer == 0: 
    ...
    if '6' in user_answers:
        ...
        if math_answer == 0:   
            ...
            if '6.2' in user_answers:
                no_math_answer = user_answers['6.2']
                if no_math_answer == 0: 
                    tags["Department"].append("UI/UX Design")
